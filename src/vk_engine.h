...
public:
    ...
    VkPipeline _wireframePipeline;
    VkPipelineLayout _wireframePipelineLayout;
    ...
    VkPipeline _2dPipeline;
    VkPipeline _gridPipeline;
    VkPipeline _emissivePipeline;
    ...
    VkPipelineLayout _emissivePipelineLayout;

    VkPipeline _pointLightVisPipeline;
    VkPipelineLayout _pointLightVisPipelineLayout;





    VkPipeline _outlinePipeline;
    VkPipelineLayout _outlinePipelineLayout;
    ...
    VkPipeline _2dPipelineDoubleSided;
    VkPipeline _2dPipelineCulled;
    ...
    VkPipeline _2dPipeline_CullOn;
    VkPipeline _2dPipeline_CullOff;

    VkPipelineLayout _2dPipelineLayout;
    ...
    VkDescriptorSet _2dDescriptorSet;
   ...
   () { return _frames[_frameNumber % FRAME_OVERLAP]; };*/
    ...
    VkDescriptorSet _pathTraceDescriptorSet;
    VkPipeline _pathTracePipeline;
    VkPipelineLayout _pathTracePipelineLayout;
    ...
    void draw_wireframe_outline(VkCommandBuffer cmd, const RenderObject& obj, VkDescriptorSet descriptor);
