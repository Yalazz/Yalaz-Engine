...
void PipelineBuilder::set_vertex_input(const VertexInputDescription& description)
{
    _vertexBindings = description.bindings;
    _vertexAttributes = description.attributes;
...
void PipelineBuilder::clear()
{
    ...
    // Initialize vertex input state (empty by default, can be overridden)
    _vertexInputInfo = { .sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO };
...
//    // connect the renderInfo to the pNext extension mechanism
//    pipelineInfo.pNext = &_renderInfo;
//    pipelineInfo.renderPass = VK_NULL_HANDLE;//BUNDAN GRAM EMIN DEGILIM PATLARSA BUNU KONTROL EEEEEEEEETTTTTTTTTTTTTTTTTTTT
//
//
//
//    pipelineInfo.stageCount = (uint32_t)_shaderStages.size();
...
VkPipeline PipelineBuilder::build_pipeline(VkDevice device)
{
    // Dinamik viewport ve scissor desteği
    VkPipelineViewportStateCreateInfo viewportState = {};
    viewportState.sType = VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO;
    viewportState.pNext = nullptr;
    viewportState.viewportCount = 1;
    ...
    // Color blending (önce additive, sonra diğer blend türleri eklenebilir)
    VkPipelineColorBlendStateCreateInfo colorBlending = {};
    colorBlending.sType = VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO;
    colorBlending.pNext = nullptr;
    colorBlending.logicOpEnable = VK_FALSE;
    ...
    // Dynamic state (viewport ve scissor)
    ...
    pipelineInfo.pNext = &_renderInfo; // dynamic rendering
    ...
    pipelineInfo.layout = _pipelineLayout;
    pipelineInfo.renderPass = VK_NULL_HANDLE; // dynamic rendering kullanımı
