...
VkPipelineViewportStateCreateInfo vkinit::viewport_state_create_info(VkViewport* viewport, VkRect2D* scissor) {
...
VkViewport vkinit::viewport(float width, float height, float x, float y) {
    VkViewport viewport = {};
    viewport.x = x;
    viewport.y = y;
...
VkRect2D vkinit::scissor(int width, int height, int x, int y) {
    VkRect2D scissor = {};
    scissor.offset = { x, y };
...
VkPipelineColorBlendStateCreateInfo vkinit::color_blend_state_create_info(uint32_t attachmentCount, const VkPipelineColorBlendAttachmentState* attachments) {
