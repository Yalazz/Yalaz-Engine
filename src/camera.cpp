...
void Camera::processSDLEvent(SDL_Event& e) {
    ...
    // Use WantTextInput instead of WantCaptureKeyboard to allow WASD movement
    // even when ImGui windows have focus (Nav keyboard enabled)
    if (e.type == SDL_KEYDOWN || e.type == SDL_KEYUP) {
        // Only block keyboard when user is actually typing in a text field
